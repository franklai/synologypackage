...
// 	var path = param[0].get("path");
	...
	SYNO.SDS.AppLaunch('com.blogspot.fujirou2.DivXPlayer.Application', {
		fb_recs: param
	});
};

com.blogspot.fujirou2.DivXPlayer.Application = Ext.extend(SYNO.SDS.AppInstance, {
	appWindowName: "com.blogspot.fujirou2.DivXPlayer.MainWindow",
	constructor: function (cfg) {
		com.blogspot.fujirou2.DivXPlayer.Application.superclass.constructor.apply(this, arguments);
	}
});
...
com.blogspot.fujirou2.DivXPlayer.MainWindow = Ext.extend(SYNO.SDS.AppWindow, {
	...
	onOpen: function () {
		com.blogspot.fujirou2.DivXPlayer.MainWindow.superclass.onOpen.apply(this, arguments);
