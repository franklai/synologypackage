...
#
# icon is from
# http://www.iconarchive.com/show/superhero-avatar-icons-by-deleket/Avengers-Iron-Man-icon.html

SPK_FILE="HelloWorld.spk"
...
make()
{
	...
	cp -af ui/images/Avengers-Iron-Man-icon-72.png _spk_dst/PACKAGE_ICON.PNG
